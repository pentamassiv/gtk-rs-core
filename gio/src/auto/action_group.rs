...
pub trait ActionGroupExt: IsA<ActionGroup> + sealed::Sealed + 'static {
    ...
    fn action_enabled_changed(&self, action_name: &str, enabled: bool) {
        unsafe {
            ffi::g_action_group_action_enabled_changed(self.as_ref().to_glib_none().0, action_name.to_glib_none().0, enabled.into_glib());
        }
    }
    ...
    fn connect_action_added<F: Fn(&Self, &str) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn action_added_trampoline<P: IsA<ActionGroup>, F: Fn(&P, &str) + 'static>(this: *mut ffi::GActionGroup, action_name: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ActionGroup::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(action_name))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            let detailed_signal_name = detail.map(|name| { format!("action-added::{name}\0") });
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"action-added\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(action_added_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_action_enabled_changed<F: Fn(&Self, &str, bool) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn action_enabled_changed_trampoline<P: IsA<ActionGroup>, F: Fn(&P, &str, bool) + 'static>(this: *mut ffi::GActionGroup, action_name: *mut libc::c_char, enabled: glib::ffi::gboolean, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ActionGroup::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(action_name), from_glib(enabled))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            let detailed_signal_name = detail.map(|name| { format!("action-enabled-changed::{name}\0") });
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"action-enabled-changed\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(action_enabled_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "action-removed")]
    fn connect_action_removed<F: Fn(&Self, &str) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn action_removed_trampoline<P: IsA<ActionGroup>, F: Fn(&P, &str) + 'static>(this: *mut ffi::GActionGroup, action_name: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ActionGroup::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(action_name))
        }
        unsafe {
            ...
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"action-removed\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(action_removed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "action-state-changed")]
    fn connect_action_state_changed<F: Fn(&Self, &str, &glib::Variant) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn action_state_changed_trampoline<P: IsA<ActionGroup>, F: Fn(&P, &str, &glib::Variant) + 'static>(this: *mut ffi::GActionGroup, action_name: *mut libc::c_char, value: *mut glib::ffi::GVariant, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ActionGroup::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(action_name), &from_glib_borrow(value))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            let detailed_signal_name = detail.map(|name| { format!("action-state-changed::{name}\0") });
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"action-state-changed\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(action_state_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
