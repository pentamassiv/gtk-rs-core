...
use crate::{DBusConnection,DBusInterface,DBusInterfaceInfo,DBusInterfaceSkeletonFlags,DBusMethodInvocation};
...
pub trait DBusInterfaceSkeletonExt: IsA<DBusInterfaceSkeleton> + sealed::Sealed + 'static {
    ...
    fn export(&self, connection: &DBusConnection, object_path: &str) -> Result<(), glib::Error> {
        unsafe {
            ...
            let is_ok = ffi::g_dbus_interface_skeleton_export(self.as_ref().to_glib_none().0, connection.to_glib_none().0, object_path.to_glib_none().0, &mut error);
    ...
    fn connection(&self) -> Option<DBusConnection> {
        unsafe {
            from_glib_none(ffi::g_dbus_interface_skeleton_get_connection(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connections(&self) -> Vec<DBusConnection> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(ffi::g_dbus_interface_skeleton_get_connections(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn flags(&self) -> DBusInterfaceSkeletonFlags {
        unsafe {
            from_glib(ffi::g_dbus_interface_skeleton_get_flags(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn info(&self) -> DBusInterfaceInfo {
        unsafe {
            from_glib_none(ffi::g_dbus_interface_skeleton_get_info(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn object_path(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::g_dbus_interface_skeleton_get_object_path(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn properties(&self) -> glib::Variant {
        unsafe {
            from_glib_full(ffi::g_dbus_interface_skeleton_get_properties(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn has_connection(&self, connection: &DBusConnection) -> bool {
        unsafe {
            from_glib(ffi::g_dbus_interface_skeleton_has_connection(self.as_ref().to_glib_none().0, connection.to_glib_none().0))
        }
    }
    ...
    fn set_flags(&self, flags: DBusInterfaceSkeletonFlags) {
        unsafe {
            ffi::g_dbus_interface_skeleton_set_flags(self.as_ref().to_glib_none().0, flags.into_glib());
        }
    }
    ...
    fn unexport_from_connection(&self, connection: &DBusConnection) {
        unsafe {
            ffi::g_dbus_interface_skeleton_unexport_from_connection(self.as_ref().to_glib_none().0, connection.to_glib_none().0);
        }
    }
    ...
    fn connect_g_authorize_method<F: Fn(&Self, &DBusMethodInvocation) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn g_authorize_method_trampoline<P: IsA<DBusInterfaceSkeleton>, F: Fn(&P, &DBusMethodInvocation) -> bool + 'static>(this: *mut ffi::GDBusInterfaceSkeleton, invocation: *mut ffi::GDBusMethodInvocation, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(DBusInterfaceSkeleton::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(invocation)).into_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"g-authorize-method\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(g_authorize_method_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "g-flags")]
    fn connect_g_flags_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_g_flags_trampoline<P: IsA<DBusInterfaceSkeleton>, F: Fn(&P) + 'static>(this: *mut ffi::GDBusInterfaceSkeleton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DBusInterfaceSkeleton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::g-flags\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_g_flags_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
