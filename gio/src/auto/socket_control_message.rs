...
impl SocketControlMessage {
    ...
    pub fn deserialize(level: i32, type_: i32, data: &[u8]) -> Option<SocketControlMessage> {
        ...
        unsafe {
            from_glib_full(ffi::g_socket_control_message_deserialize(level, type_, size, data.to_glib_none().0 as glib::ffi::gpointer))
        }
    }
}
...
pub trait SocketControlMessageExt: IsA<SocketControlMessage> + sealed::Sealed + 'static {
    ...
    fn level(&self) -> i32 {
        unsafe {
            ffi::g_socket_control_message_get_level(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn msg_type(&self) -> i32 {
        unsafe {
            ffi::g_socket_control_message_get_msg_type(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn size(&self) -> usize {
        unsafe {
            ffi::g_socket_control_message_get_size(self.as_ref().to_glib_none().0)
        }
    }
}
