...
pub trait SocketAddressExt: IsA<SocketAddress> + sealed::Sealed + 'static {
    ...
    fn connect_family_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_family_trampoline<P: IsA<SocketAddress>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::GSocketAddress, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
