...
impl UnixMountPoint {
    #[doc(alias = "g_unix_mount_point_compare")]
     fn compare(&self, mount2: &UnixMountPoint) -> i32 {
        unsafe {
            ffi::g_unix_mount_point_compare(mut_override(self.to_glib_none().0), mut_override(mount2.to_glib_none().0))
        }
    }
    ...
    pub fn device_path(&self) -> std::path::PathBuf {
        unsafe {
            from_glib_none(ffi::g_unix_mount_point_get_device_path(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn fs_type(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::g_unix_mount_point_get_fs_type(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn mount_path(&self) -> std::path::PathBuf {
        unsafe {
            from_glib_none(ffi::g_unix_mount_point_get_mount_path(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn options(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::g_unix_mount_point_get_options(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn guess_can_eject(&self) -> bool {
        unsafe {
            from_glib(ffi::g_unix_mount_point_guess_can_eject(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn guess_icon(&self) -> Icon {
        unsafe {
            from_glib_full(ffi::g_unix_mount_point_guess_icon(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn guess_name(&self) -> glib::GString {
        unsafe {
            from_glib_full(ffi::g_unix_mount_point_guess_name(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn guess_symbolic_icon(&self) -> Icon {
        unsafe {
            from_glib_full(ffi::g_unix_mount_point_guess_symbolic_icon(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn is_loopback(&self) -> bool {
        unsafe {
            from_glib(ffi::g_unix_mount_point_is_loopback(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn is_readonly(&self) -> bool {
        unsafe {
            from_glib(ffi::g_unix_mount_point_is_readonly(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn is_user_mountable(&self) -> bool {
        unsafe {
            from_glib(ffi::g_unix_mount_point_is_user_mountable(mut_override(self.to_glib_none().0)))
        }
    }
    ...
    pub fn at(mount_path: impl AsRef<std::path::Path>) -> (Option<UnixMountPoint>, u64) {
        unsafe {
            ...
            let ret = from_glib_full(ffi::g_unix_mount_point_at(mount_path.as_ref().to_glib_none().0, time_read.as_mut_ptr()));
