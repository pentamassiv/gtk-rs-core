...
impl DBusMethodInvocation {
    ...
    pub fn connection(&self) -> DBusConnection {
        unsafe {
            from_glib_none(ffi::g_dbus_method_invocation_get_connection(self.to_glib_none().0))
        }
    }
    ...
    pub fn interface_name(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::g_dbus_method_invocation_get_interface_name(self.to_glib_none().0))
        }
    }
    ...
    pub fn message(&self) -> DBusMessage {
        unsafe {
            from_glib_none(ffi::g_dbus_method_invocation_get_message(self.to_glib_none().0))
        }
    }
    ...
    pub fn method_info(&self) -> Option<DBusMethodInfo> {
        unsafe {
            from_glib_none(ffi::g_dbus_method_invocation_get_method_info(self.to_glib_none().0))
        }
    }
    ...
    pub fn method_name(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::g_dbus_method_invocation_get_method_name(self.to_glib_none().0))
        }
    }
    ...
    pub fn object_path(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::g_dbus_method_invocation_get_object_path(self.to_glib_none().0))
        }
    }
    ...
    pub fn parameters(&self) -> glib::Variant {
        unsafe {
            from_glib_none(ffi::g_dbus_method_invocation_get_parameters(self.to_glib_none().0))
        }
    }
    ...
    pub fn property_info(&self) -> Option<DBusPropertyInfo> {
        unsafe {
            from_glib_none(ffi::g_dbus_method_invocation_get_property_info(self.to_glib_none().0))
        }
    }
    ...
    pub fn sender(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::g_dbus_method_invocation_get_sender(self.to_glib_none().0))
        }
    }
    ...
    pub fn return_dbus_error(self, error_name: &str, error_message: &str) {
        unsafe {
            ffi::g_dbus_method_invocation_return_dbus_error(self.into_glib_ptr(), error_name.to_glib_none().0, error_message.to_glib_none().0);
        }
    }
    ...
    pub fn return_value(self, parameters: Option<&glib::Variant>) {
        unsafe {
            ffi::g_dbus_method_invocation_return_value(self.into_glib_ptr(), parameters.to_glib_none().0);
        }
    }
    ...
    pub fn return_value_with_unix_fd_list(self, parameters: Option<&glib::Variant>, fd_list: Option<&impl IsA<UnixFDList>>) {
        unsafe {
            ffi::g_dbus_method_invocation_return_value_with_unix_fd_list(self.into_glib_ptr(), parameters.to_glib_none().0, fd_list.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
}
