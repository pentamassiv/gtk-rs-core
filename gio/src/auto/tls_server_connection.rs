...
impl TlsServerConnection {
    ...
    pub fn new(base_io_stream: &impl IsA<IOStream>, certificate: Option<&impl IsA<TlsCertificate>>) -> Result<TlsServerConnection, glib::Error> {
        unsafe {
...
pub trait TlsServerConnectionExt: IsA<TlsServerConnection> + sealed::Sealed + 'static {
    ...
    fn connect_authentication_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_authentication_mode_trampoline<P: IsA<TlsServerConnection>, F: Fn(&P) + 'static>(this: *mut ffi::GTlsServerConnection, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::authentication-mode\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_authentication_mode_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
