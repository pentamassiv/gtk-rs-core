...
pub trait SocketServiceExt: IsA<SocketService> + sealed::Sealed + 'static {
    ...
    fn connect_incoming<F: Fn(&Self, &SocketConnection, Option<&glib::Object>) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn incoming_trampoline<P: IsA<SocketService>, F: Fn(&P, &SocketConnection, Option<&glib::Object>) -> bool + 'static>(this: *mut ffi::GSocketService, connection: *mut ffi::GSocketConnection, source_object: *mut glib::gobject_ffi::GObject, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(SocketService::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(connection), Option::<glib::Object>::from_glib_borrow(source_object).as_ref().as_ref()).into_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"incoming\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(incoming_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "active")]
    fn connect_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_active_trampoline<P: IsA<SocketService>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketService, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
