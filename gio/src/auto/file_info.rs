...
#[must_use]
    ...
    pub fn access_date_time(&self) -> Option<glib::DateTime> {
        unsafe {
            from_glib_full(ffi::g_file_info_get_access_date_time(self.to_glib_none().0))
        }
    }
    ...
    pub fn attribute_file_path(&self, attribute: &str) -> Option<std::path::PathBuf> {
        unsafe {
            from_glib_none(ffi::g_file_info_get_attribute_file_path(self.to_glib_none().0, attribute.to_glib_none().0))
        }
    }
    ...
    pub fn attribute_status(&self, attribute: &str) -> FileAttributeStatus {
        unsafe {
            from_glib(ffi::g_file_info_get_attribute_status(self.to_glib_none().0, attribute.to_glib_none().0))
        }
    }
    ...
    pub fn attribute_type(&self, attribute: &str) -> FileAttributeType {
        unsafe {
            from_glib(ffi::g_file_info_get_attribute_type(self.to_glib_none().0, attribute.to_glib_none().0))
        }
    }
    ...
    pub fn creation_date_time(&self) -> Option<glib::DateTime> {
        unsafe {
            from_glib_full(ffi::g_file_info_get_creation_date_time(self.to_glib_none().0))
        }
    }
    ...
    pub fn deletion_date(&self) -> Option<glib::DateTime> {
        unsafe {
            from_glib_full(ffi::g_file_info_get_deletion_date(self.to_glib_none().0))
        }
    }
    ...
    pub fn modification_date_time(&self) -> Option<glib::DateTime> {
        unsafe {
            from_glib_full(ffi::g_file_info_get_modification_date_time(self.to_glib_none().0))
        }
    }
    ...
    pub fn list_attributes(&self, name_space: Option<&str>) -> Vec<glib::GString> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(ffi::g_file_info_list_attributes(self.to_glib_none().0, name_space.to_glib_none().0))
        }
    }
    ...
    pub fn set_attribute_boolean(&self, attribute: &str, attr_value: bool) {
        unsafe {
            ffi::g_file_info_set_attribute_boolean(self.to_glib_none().0, attribute.to_glib_none().0, attr_value.into_glib());
        }
    }
    ...
    pub fn set_attribute_file_path(&self, attribute: &str, attr_value: impl AsRef<std::path::Path>) {
        unsafe {
            ffi::g_file_info_set_attribute_file_path(self.to_glib_none().0, attribute.to_glib_none().0, attr_value.as_ref().to_glib_none().0);
        }
    }
    ...
    pub fn set_attribute_object(&self, attribute: &str, attr_value: &impl IsA<glib::Object>) {
        unsafe {
            ffi::g_file_info_set_attribute_object(self.to_glib_none().0, attribute.to_glib_none().0, attr_value.as_ref().to_glib_none().0);
        }
    }
    ...
    pub fn set_attribute_status(&self, attribute: &str, status: FileAttributeStatus) -> bool {
        unsafe {
            from_glib(ffi::g_file_info_set_attribute_status(self.to_glib_none().0, attribute.to_glib_none().0, status.into_glib()))
        }
    }
    ...
    pub fn set_creation_date_time(&self, creation_time: &glib::DateTime) {
        unsafe {
            ffi::g_file_info_set_creation_date_time(self.to_glib_none().0, creation_time.to_glib_none().0);
        }
    }
    ...
    pub fn set_modification_date_time(&self, mtime: &glib::DateTime) {
        unsafe {
            ffi::g_file_info_set_modification_date_time(self.to_glib_none().0, mtime.to_glib_none().0);
        }
    }
    ...
    pub fn set_symbolic_icon(&self, icon: &impl IsA<Icon>) {
        unsafe {
            ffi::g_file_info_set_symbolic_icon(self.to_glib_none().0, icon.as_ref().to_glib_none().0);
        }
    }
    ...
    pub fn set_symlink_target(&self, symlink_target: impl AsRef<std::path::Path>) {
        unsafe {
            ffi::g_file_info_set_symlink_target(self.to_glib_none().0, symlink_target.as_ref().to_glib_none().0);
        }
    }
