...
impl CharsetConverter {
    ...
    pub fn set_use_fallback(&self, use_fallback: bool) {
        unsafe {
            ffi::g_charset_converter_set_use_fallback(self.to_glib_none().0, use_fallback.into_glib());
        }
    }
    ...
    pub fn connect_use_fallback_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_use_fallback_trampoline<F: Fn(&CharsetConverter) + 'static>(this: *mut ffi::GCharsetConverter, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::use-fallback\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_use_fallback_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
...
pub struct CharsetConverterBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("from-charset", from_charset.into()), }
                        }

                            pub fn to_charset(self, to_charset: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("to-charset", to_charset.into()), }
                        }
