...
impl Menu {
    ...
    pub fn insert_section(&self, position: i32, label: Option<&str>, section: &impl IsA<MenuModel>) {
        unsafe {
    ...
    pub fn insert_submenu(&self, position: i32, label: Option<&str>, submenu: &impl IsA<MenuModel>) {
        unsafe {
