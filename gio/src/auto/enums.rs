...
impl fmt::Display for DBusMessageByteOrder {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "DBusMessageByteOrder::{}", match *self {
...
impl fmt::Display for DBusMessageHeaderField {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "DBusMessageHeaderField::{}", match *self {
            Self::Invalid => "Invalid",
            Self::Path => "Path",
...
impl fmt::Display for DBusMessageType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "DBusMessageType::{}", match *self {
            Self::Invalid => "Invalid",
...
impl fmt::Display for MemoryMonitorWarningLevel {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "MemoryMonitorWarningLevel::{}", match *self {
            Self::Low => "Low",
            Self::Medium => "Medium",
...
impl fmt::Display for PollableReturn {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "PollableReturn::{}", match *self {
            Self::Failed => "Failed",
            Self::Ok => "Ok",
            Self::WouldBlock => "WouldBlock",
            _ => "Unknown",
...
impl fmt::Display for ResolverError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ResolverError::{}", match *self {
            Self::NotFound => "NotFound",
...
impl fmt::Display for TlsChannelBindingType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "TlsChannelBindingType::{}", match *self {
            Self::Unique => "Unique",
...
impl fmt::Display for TlsProtocolVersion {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "TlsProtocolVersion::{}", match *self {
            Self::Unknown => "Unknown",
            Self::Ssl30 => "Ssl30",
            Self::Tls10 => "Tls10",
            Self::Tls11 => "Tls11",
