...
impl ConverterOutputStream {
    ...
    pub fn new(base_stream: &impl IsA<OutputStream>, converter: &impl IsA<Converter>) -> ConverterOutputStream {
        unsafe {
...
pub struct ConverterOutputStreamBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("converter", converter.clone().upcast()), }
                        }
