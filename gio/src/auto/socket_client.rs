...
use crate::{AsyncResult,Cancellable,IOStream,ProxyResolver,SocketAddress,SocketClientEvent,SocketConnectable,SocketConnection,SocketFamily,SocketProtocol,SocketType,TlsCertificateFlags};
...
pub trait SocketClientExt: IsA<SocketClient> + sealed::Sealed + 'static {
    ...
    fn connect(&self, connectable: &impl IsA<SocketConnectable>, cancellable: Option<&impl IsA<Cancellable>>) -> Result<SocketConnection, glib::Error> {
        unsafe {
    ...
    fn connect_async<P: FnOnce(Result<SocketConnection, glib::Error>) + 'static>(&self, connectable: &impl IsA<SocketConnectable>, cancellable: Option<&impl IsA<Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn connect_async_trampoline<P: FnOnce(Result<SocketConnection, glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut crate::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
        ...
        unsafe {
            ffi::g_socket_client_connect_async(self.as_ref().to_glib_none().0, connectable.as_ref().to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }

    
    fn connect_future(&self, connectable: &(impl IsA<SocketConnectable> + Clone + 'static)) -> Pin<Box_<dyn std::future::Future<Output = Result<SocketConnection, glib::Error>> + 'static>> {
    ...
    fn connect_to_host(&self, host_and_port: &str, default_port: u16, cancellable: Option<&impl IsA<Cancellable>>) -> Result<SocketConnection, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    fn connect_to_host_async<P: FnOnce(Result<SocketConnection, glib::Error>) + 'static>(&self, host_and_port: &str, default_port: u16, cancellable: Option<&impl IsA<Cancellable>>, callback: P) {
        ...
        let user_data: Box_<glib::thread_guard::ThreadGuard<P>> = Box_::new(glib::thread_guard::ThreadGuard::new(callback));
        unsafe extern "C" fn connect_to_host_async_trampoline<P: FnOnce(Result<SocketConnection, glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut crate::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
        ...
        unsafe {
            ffi::g_socket_client_connect_to_host_async(self.as_ref().to_glib_none().0, host_and_port.to_glib_none().0, default_port, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }

    
    fn connect_to_host_future(&self, host_and_port: &str, default_port: u16) -> Pin<Box_<dyn std::future::Future<Output = Result<SocketConnection, glib::Error>> + 'static>> {
    ...
    fn connect_to_service(&self, domain: &str, service: &str, cancellable: Option<&impl IsA<Cancellable>>) -> Result<SocketConnection, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    fn connect_to_service_async<P: FnOnce(Result<SocketConnection, glib::Error>) + 'static>(&self, domain: &str, service: &str, cancellable: Option<&impl IsA<Cancellable>>, callback: P) {
        ...
        let user_data: Box_<glib::thread_guard::ThreadGuard<P>> = Box_::new(glib::thread_guard::ThreadGuard::new(callback));
        unsafe extern "C" fn connect_to_service_async_trampoline<P: FnOnce(Result<SocketConnection, glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut crate::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
        ...
        unsafe {
            ffi::g_socket_client_connect_to_service_async(self.as_ref().to_glib_none().0, domain.to_glib_none().0, service.to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }

    
    fn connect_to_service_future(&self, domain: &str, service: &str) -> Pin<Box_<dyn std::future::Future<Output = Result<SocketConnection, glib::Error>> + 'static>> {
    ...
    fn connect_to_uri(&self, uri: &str, default_port: u16, cancellable: Option<&impl IsA<Cancellable>>) -> Result<SocketConnection, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    fn connect_to_uri_async<P: FnOnce(Result<SocketConnection, glib::Error>) + 'static>(&self, uri: &str, default_port: u16, cancellable: Option<&impl IsA<Cancellable>>, callback: P) {
        ...
        let user_data: Box_<glib::thread_guard::ThreadGuard<P>> = Box_::new(glib::thread_guard::ThreadGuard::new(callback));
        unsafe extern "C" fn connect_to_uri_async_trampoline<P: FnOnce(Result<SocketConnection, glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut crate::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
        ...
        unsafe {
            ffi::g_socket_client_connect_to_uri_async(self.as_ref().to_glib_none().0, uri.to_glib_none().0, default_port, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }

    
    fn connect_to_uri_future(&self, uri: &str, default_port: u16) -> Pin<Box_<dyn std::future::Future<Output = Result<SocketConnection, glib::Error>> + 'static>> {
    ...
    fn set_enable_proxy(&self, enable: bool) {
        unsafe {
            ffi::g_socket_client_set_enable_proxy(self.as_ref().to_glib_none().0, enable.into_glib());
        }
    }
    ...
    fn set_tls_validation_flags(&self, flags: TlsCertificateFlags) {
        unsafe {
            ffi::g_socket_client_set_tls_validation_flags(self.as_ref().to_glib_none().0, flags.into_glib());
        }
    }
    ...
    fn connect_event<F: Fn(&Self, SocketClientEvent, &SocketConnectable, Option<&IOStream>) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn event_trampoline<P: IsA<SocketClient>, F: Fn(&P, SocketClientEvent, &SocketConnectable, Option<&IOStream>) + 'static>(this: *mut ffi::GSocketClient, event: ffi::GSocketClientEvent, connectable: *mut ffi::GSocketConnectable, connection: *mut ffi::GIOStream, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SocketClient::from_glib_borrow(this).unsafe_cast_ref(), from_glib(event), &from_glib_borrow(connectable), Option::<IOStream>::from_glib_borrow(connection).as_ref().as_ref())
        }
        unsafe {
    ...
    fn connect_enable_proxy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_enable_proxy_trampoline<P: IsA<SocketClient>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketClient, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::enable-proxy\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_enable_proxy_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "family")]
    fn connect_family_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_family_trampoline<P: IsA<SocketClient>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketClient, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SocketClient::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::family\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_family_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "local-address")]
    fn connect_local_address_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_local_address_trampoline<P: IsA<SocketClient>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketClient, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SocketClient::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::local-address\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_local_address_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "protocol")]
    fn connect_protocol_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_protocol_trampoline<P: IsA<SocketClient>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketClient, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SocketClient::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_proxy_resolver_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_proxy_resolver_trampoline<P: IsA<SocketClient>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketClient, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SocketClient::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_timeout_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_timeout_trampoline<P: IsA<SocketClient>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketClient, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SocketClient::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_tls_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tls_trampoline<P: IsA<SocketClient>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketClient, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SocketClient::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::tls\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_tls_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_tls_validation_flags_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tls_validation_flags_trampoline<P: IsA<SocketClient>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketClient, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SocketClient::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::tls-validation-flags\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_tls_validation_flags_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "type")]
    fn connect_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P: IsA<SocketClient>, F: Fn(&P) + 'static>(this: *mut ffi::GSocketClient, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SocketClient::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
