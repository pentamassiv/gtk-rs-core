...
impl DBusInterfaceInfo {
    ...
    pub fn lookup_method(&self, name: &str) -> Option<DBusMethodInfo> {
        unsafe {
            from_glib_none(ffi::g_dbus_interface_info_lookup_method(self.to_glib_none().0, name.to_glib_none().0))
        }
    }
    ...
    pub fn lookup_property(&self, name: &str) -> Option<DBusPropertyInfo> {
        unsafe {
            from_glib_none(ffi::g_dbus_interface_info_lookup_property(self.to_glib_none().0, name.to_glib_none().0))
        }
    }
    ...
    pub fn lookup_signal(&self, name: &str) -> Option<DBusSignalInfo> {
        unsafe {
            from_glib_none(ffi::g_dbus_interface_info_lookup_signal(self.to_glib_none().0, name.to_glib_none().0))
        }
    }
}
