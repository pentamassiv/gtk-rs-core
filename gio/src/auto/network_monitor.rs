...
impl NetworkMonitor {
    ...
    #[allow(clippy::should_implement_trait)]    pub fn default() -> NetworkMonitor {
        unsafe {
...
pub trait NetworkMonitorExt: IsA<NetworkMonitor> + sealed::Sealed + 'static {
    ...
    fn can_reach(&self, connectable: &impl IsA<SocketConnectable>, cancellable: Option<&impl IsA<Cancellable>>) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let is_ok = ffi::g_network_monitor_can_reach(self.as_ref().to_glib_none().0, connectable.as_ref().to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, &mut error);
    ...
    fn can_reach_async<P: FnOnce(Result<(), glib::Error>) + 'static>(&self, connectable: &impl IsA<SocketConnectable>, cancellable: Option<&impl IsA<Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn can_reach_async_trampoline<P: FnOnce(Result<(), glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut crate::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
        ...
        unsafe {
            ffi::g_network_monitor_can_reach_async(self.as_ref().to_glib_none().0, connectable.as_ref().to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }

    
    fn can_reach_future(&self, connectable: &(impl IsA<SocketConnectable> + Clone + 'static)) -> Pin<Box_<dyn std::future::Future<Output = Result<(), glib::Error>> + 'static>> {
    ...
    fn connect_network_changed<F: Fn(&Self, bool) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn network_changed_trampoline<P: IsA<NetworkMonitor>, F: Fn(&P, bool) + 'static>(this: *mut ffi::GNetworkMonitor, network_available: glib::ffi::gboolean, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(NetworkMonitor::from_glib_borrow(this).unsafe_cast_ref(), from_glib(network_available))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"network-changed\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(network_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "connectivity")]
    fn connect_connectivity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_connectivity_trampoline<P: IsA<NetworkMonitor>, F: Fn(&P) + 'static>(this: *mut ffi::GNetworkMonitor, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::connectivity\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_connectivity_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "network-available")]
    fn connect_network_available_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_network_available_trampoline<P: IsA<NetworkMonitor>, F: Fn(&P) + 'static>(this: *mut ffi::GNetworkMonitor, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(NetworkMonitor::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::network-available\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_network_available_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "network-metered")]
    fn connect_network_metered_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_network_metered_trampoline<P: IsA<NetworkMonitor>, F: Fn(&P) + 'static>(this: *mut ffi::GNetworkMonitor, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(NetworkMonitor::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::network-metered\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_network_metered_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
