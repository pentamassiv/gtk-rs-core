...
impl ListStore {
    ...
    pub fn find(&self, item: &impl IsA<glib::Object>) -> Option<u32> {
        unsafe {
            ...
            let ret = from_glib(ffi::g_list_store_find(self.to_glib_none().0, item.as_ref().to_glib_none().0, position.as_mut_ptr()));
            if ret { Some(position.assume_init()) } else { None }
        }
    }
    ...
    pub fn insert(&self, position: u32, item: &impl IsA<glib::Object>) {
        unsafe {
            ffi::g_list_store_insert(self.to_glib_none().0, position, item.as_ref().to_glib_none().0);
        }
    }
...
pub struct ListStoreBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("item-type", item_type), }
                        }
