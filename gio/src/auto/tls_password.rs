...
impl TlsPassword {
    ...
    pub fn new(flags: TlsPasswordFlags, description: &str) -> TlsPassword {
        unsafe {
            from_glib_full(ffi::g_tls_password_new(flags.into_glib(), description.to_glib_none().0))
        }
    }
}
...
pub trait TlsPasswordExt: IsA<TlsPassword> + sealed::Sealed + 'static {
    ...
    fn connect_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_description_trampoline<P: IsA<TlsPassword>, F: Fn(&P) + 'static>(this: *mut ffi::GTlsPassword, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_flags_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_flags_trampoline<P: IsA<TlsPassword>, F: Fn(&P) + 'static>(this: *mut ffi::GTlsPassword, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TlsPassword::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_warning_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_warning_trampoline<P: IsA<TlsPassword>, F: Fn(&P) + 'static>(this: *mut ffi::GTlsPassword, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TlsPassword::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::warning\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_warning_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
