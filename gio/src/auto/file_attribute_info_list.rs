...
impl FileAttributeInfoList {
    ...
    pub fn new() -> FileAttributeInfoList {
        unsafe {
            from_glib_full(ffi::g_file_attribute_info_list_new())
        }
    }
    ...
    pub fn add(&self, name: &str, type_: FileAttributeType, flags: FileAttributeInfoFlags) {
        unsafe {
            ffi::g_file_attribute_info_list_add(self.to_glib_none().0, name.to_glib_none().0, type_.into_glib(), flags.into_glib());
        }
    }
...
#[must_use]
    pub fn dup(&self) -> FileAttributeInfoList {
        unsafe {
            from_glib_full(ffi::g_file_attribute_info_list_dup(self.to_glib_none().0))
        }
    }
}
