...
pub trait SettingsExt: IsA<Settings> + sealed::Sealed + 'static {
    ...
    fn bind_writable(&self, key: &str, object: &impl IsA<glib::Object>, property: &str, inverted: bool) {
        unsafe {
            ffi::g_settings_bind_writable(self.as_ref().to_glib_none().0, key.to_glib_none().0, object.as_ref().to_glib_none().0, property.to_glib_none().0, inverted.into_glib());
        }
    }
...
#[must_use]
    ...
    fn set_boolean(&self, key: &str, value: bool) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_boolean(self.as_ref().to_glib_none().0, key.to_glib_none().0, value.into_glib()), "Can't set readonly key")
        }
    }
    ...
    fn set_double(&self, key: &str, value: f64) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_double(self.as_ref().to_glib_none().0, key.to_glib_none().0, value), "Can't set readonly key")
        }
    }
    ...
    fn set_enum(&self, key: &str, value: i32) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_enum(self.as_ref().to_glib_none().0, key.to_glib_none().0, value), "Can't set readonly key")
        }
    }
    ...
    fn set_flags(&self, key: &str, value: u32) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_flags(self.as_ref().to_glib_none().0, key.to_glib_none().0, value), "Can't set readonly key")
        }
    }
    ...
    fn set_int(&self, key: &str, value: i32) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_int(self.as_ref().to_glib_none().0, key.to_glib_none().0, value), "Can't set readonly key")
        }
    }
    ...
    fn set_int64(&self, key: &str, value: i64) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_int64(self.as_ref().to_glib_none().0, key.to_glib_none().0, value), "Can't set readonly key")
        }
    }
    ...
    fn set_string(&self, key: &str, value: &str) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_string(self.as_ref().to_glib_none().0, key.to_glib_none().0, value.to_glib_none().0), "Can't set readonly key")
        }
    }
    ...
    fn set_uint(&self, key: &str, value: u32) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_uint(self.as_ref().to_glib_none().0, key.to_glib_none().0, value), "Can't set readonly key")
        }
    }
    ...
    fn set_uint64(&self, key: &str, value: u64) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_uint64(self.as_ref().to_glib_none().0, key.to_glib_none().0, value), "Can't set readonly key")
        }
    }
    ...
    fn set_value(&self, key: &str, value: &glib::Variant) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::result_from_gboolean!(ffi::g_settings_set_value(self.as_ref().to_glib_none().0, key.to_glib_none().0, value.to_glib_none().0), "Can't set readonly key")
        }
    }
    ...
    fn connect_changed<F: Fn(&Self, &str) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn changed_trampoline<P: IsA<Settings>, F: Fn(&P, &str) + 'static>(this: *mut ffi::GSettings, key: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Settings::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(key))
        }
        unsafe {
    ...
    fn connect_writable_change_event<F: Fn(&Self, u32) -> glib::Propagation + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn writable_change_event_trampoline<P: IsA<Settings>, F: Fn(&P, u32) -> glib::Propagation + 'static>(this: *mut ffi::GSettings, key: libc::c_uint, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"writable-change-event\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(writable_change_event_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "writable-changed")]
    fn connect_writable_changed<F: Fn(&Self, &str) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn writable_changed_trampoline<P: IsA<Settings>, F: Fn(&P, &str) + 'static>(this: *mut ffi::GSettings, key: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Settings::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(key))
        }
        unsafe {
            ...
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"writable-changed\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(writable_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "delay-apply")]
    fn connect_delay_apply_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_delay_apply_trampoline<P: IsA<Settings>, F: Fn(&P) + 'static>(this: *mut ffi::GSettings, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::delay-apply\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_delay_apply_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "has-unapplied")]
    fn connect_has_unapplied_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_has_unapplied_trampoline<P: IsA<Settings>, F: Fn(&P) + 'static>(this: *mut ffi::GSettings, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Settings::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::has-unapplied\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_has_unapplied_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
