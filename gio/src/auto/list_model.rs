...
pub trait ListModelExt: IsA<ListModel> + sealed::Sealed + 'static {
    ...
    fn connect_items_changed<F: Fn(&Self, u32, u32, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn items_changed_trampoline<P: IsA<ListModel>, F: Fn(&P, u32, u32, u32) + 'static>(this: *mut ffi::GListModel, position: libc::c_uint, removed: libc::c_uint, added: libc::c_uint, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListModel::from_glib_borrow(this).unsafe_cast_ref(), position, removed, added)
        }
        unsafe {
