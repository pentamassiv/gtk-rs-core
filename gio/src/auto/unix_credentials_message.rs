...
impl UnixCredentialsMessage {
    ...
    pub fn new() -> UnixCredentialsMessage {
        unsafe {
            SocketControlMessage::from_glib_full(ffi::g_unix_credentials_message_new()).unsafe_cast()
        }
    }
    ...
    pub fn with_credentials(credentials: &Credentials) -> UnixCredentialsMessage {
        unsafe {
            SocketControlMessage::from_glib_full(ffi::g_unix_credentials_message_new_with_credentials(credentials.to_glib_none().0)).unsafe_cast()
        }
    }
    ...
    pub fn is_supported() -> bool {
        unsafe {
            from_glib(ffi::g_unix_credentials_message_is_supported())
        }
    }
}
...
pub trait UnixCredentialsMessageExt: IsA<UnixCredentialsMessage> + sealed::Sealed + 'static {
    #[doc(alias = "g_unix_credentials_message_get_credentials")]
    #[doc(alias = "get_credentials")]
    fn credentials(&self) -> Credentials {
        unsafe {
            from_glib_none(ffi::g_unix_credentials_message_get_credentials(self.as_ref().to_glib_none().0))
        }
    }
}
