...
use crate::{AsyncResult,BufferedInputStream,Cancellable,DataStreamByteOrder,DataStreamNewlineType,FilterInputStream,InputStream,Seekable};
...
pub struct DataInputStreamBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("newline-type", newline_type), }
                        }
...
pub trait DataInputStreamExt: IsA<DataInputStream> + sealed::Sealed + 'static {
    ...
    fn set_byte_order(&self, order: DataStreamByteOrder) {
        unsafe {
            ffi::g_data_input_stream_set_byte_order(self.as_ref().to_glib_none().0, order.into_glib());
        }
    }
    ...
    fn set_newline_type(&self, type_: DataStreamNewlineType) {
        unsafe {
            ffi::g_data_input_stream_set_newline_type(self.as_ref().to_glib_none().0, type_.into_glib());
        }
    }

    #[doc(alias = "byte-order")]
    fn connect_byte_order_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_byte_order_trampoline<P: IsA<DataInputStream>, F: Fn(&P) + 'static>(this: *mut ffi::GDataInputStream, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_newline_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_newline_type_trampoline<P: IsA<DataInputStream>, F: Fn(&P) + 'static>(this: *mut ffi::GDataInputStream, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DataInputStream::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
