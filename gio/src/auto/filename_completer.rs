...
impl FilenameCompleter {
    ...
    pub fn connect_got_completion_data<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn got_completion_data_trampoline<F: Fn(&FilenameCompleter) + 'static>(this: *mut ffi::GFilenameCompleter, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"got-completion-data\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(got_completion_data_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
