...
impl DBusMenuModel {
    ...
    pub fn get(connection: &DBusConnection, bus_name: Option<&str>, object_path: &str) -> DBusMenuModel {
        unsafe {
            from_glib_full(ffi::g_dbus_menu_model_get(connection.to_glib_none().0, bus_name.to_glib_none().0, object_path.to_glib_none().0))
        }
    }
}
